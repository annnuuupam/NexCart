-- V2__seed.sql: NexCart database seed data (Categories, Products, Images, Settings, and Demo Users)
...
-- 2. Insert Demo Users (including a working customer_demo user)
-- BCrypt password hash for 'customer_demo' is '$2a$10$FR5izX726LSA53PsgZnH/OqZ6jExeJbIGskleqk2Bd6UEiuO4svL.'
-- BCrypt password hash for 'user99' is '$2a$10$P40m7KrK/8g5kZxpnbcjsuD2ZdHeBlzuSffCc99Nz/Xiimd/awIWq'
INSERT INTO users (username, email, password, role, blocked, status, created_at, updated_at) VALUES
('customer_demo', 'customer_demo@nexcart.com', '$2a$10$FR5izX726LSA53PsgZnH/OqZ6jExeJbIGskleqk2Bd6UEiuO4svL.', 'CUSTOMER', 0, 'ACTIVE', NOW(), NOW()),
('user99', 'user99@test.com', '$2a$10$P40m7KrK/8g5kZxpnbcjsuD2ZdHeBlzuSffCc99Nz/Xiimd/awIWq', 'CUSTOMER', 0, 'ACTIVE', NOW(), NOW())
ON DUPLICATE KEY UPDATE email = VALUES(email);

-- 3. Insert Bulk Products (Temporary Import Setup)
DROP TABLE IF EXISTS tmp_product_import;
...
-- 4. Sync Products from Temp Table
...
-- 5. Sync Product Images from Temp Table
