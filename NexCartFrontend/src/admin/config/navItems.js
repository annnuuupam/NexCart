export const adminNavItems = [
  ...
  { label: "Products", path: "/admindashboard/products" },
  { label: "Categories", path: "/admindashboard/categories" },
  { label: "Orders", path: "/admindashboard/orders" },
  { label: "Customers", path: "/admindashboard/customers" },
